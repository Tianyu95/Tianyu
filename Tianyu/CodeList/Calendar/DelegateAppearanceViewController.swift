...
class DelegateAppearanceViewController: UIViewController, FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance {
    ...
    let fillSelectionColors = ["2017/10/08": UIColor.green, "2017/10/06": UIColor.purple, "2017/10/17": UIColor.gray, "2017/10/21": UIColor.cyan, "2017/11/08": UIColor.green, "2017/11/06": UIColor.purple, "2017/11/17": UIColor.gray, "2017/11/21": UIColor.cyan, "2017/12/08": UIColor.green, "2017/12/06": UIColor.purple, "2017/12/17": UIColor.gray, "2017/12/21": UIColor.cyan]
    ...
    var datesWithEvent = ["2017-10-03", "2017-10-06", "2017-10-12", "2017-10-25"]
    var datesWithMultipleEvents = ["2017-10-08", "2017-10-16", "2017-10-20", "2017-10-28"]
    ...
    override func loadView() {
        ...
        calendar.select(self.dateFormatter1.date(from: "2017/10/03"))
